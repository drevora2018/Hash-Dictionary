...
#pragma warning disable CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    ...
    class EnumeratorOperationResult : OperationResult
    {
        ...
        public override bool Equals(Object other)
        {
            ...
            var mine = new HashSet<object>();
            while (Enumerator.MoveNext())
            {
                Console.Write(".");
                mine.Add(Enumerator.Current);
            }

            var otherOperation = (EnumeratorOperationResult)other;

            var others = new HashSet<object>();
            while (otherOperation.Enumerator.MoveNext())
            {
                others.Add(otherOperation.Enumerator.Current);
            }

            return mine.All((arg) => others.Contains(arg)) && others.All((arg) => mine.Contains(arg));
        }
